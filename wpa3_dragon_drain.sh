...
function wpa3_dragon_drain_prehook_hookable_for_languages() {
	...
	arr["GREEK","wpa3_dragon_drain_attack_1"]="\${pending_of_translation} Η επίθεση WPA3 Dragon Drain εκτελείται επ' αόριστον με σκοπό να υπερφορτώσει τον δρομολογητή (DoS)"
	...
	arr["GERMAN","wpa3_dragon_drain_attack_1"]="\${pending_of_translation} Der WPA3-Dragon-Drain-Angriff läuft ununterbrochen, um den Router zu überlasten (DoS)"
	...
	arr["GREEK","wpa3_dragon_drain_attack_5"]="\${pending_of_translation} Ένα λάθος συνέβη με την εγκατάσταση των μονάδων. Ελέγξτε τη σύνδεσή σας στο Διαδίκτυο ή εάν υπάρχει κάποιο πρόβλημα στο σύστημά σας"
	...
	arr["GERMAN","wpa3_dragon_drain_attack_5"]="\${pending_of_translation} Ein Fehler trat durch die Installation der Einheiten auf. Überprüfen Sie Ihre Internetverbindung oder wenn in Ihrem System ein Problem vorliegt"
	...
	arr["GREEK","wpa3_dragon_drain_attack_6"]="\${pending_of_translation} Θέλετε να δείτε την έξοδο του σφάλματος που δώσατε κατά την ενημέρωση/εγκατάσταση; \${blue_color}Ίσως με αυτόν τον τρόπο να βρείτε τη βασική αιτία του προβλήματος \${normal_color}\${visual_choice}"
	...
	arr["GERMAN","wpa3_dragon_drain_attack_6"]="\${pending_of_translation} Möchten Sie die Ausgabe des Fehlers sehen, der beim Aktualisierung/Installation aufgetreten ist? \${blue_color}Vielleicht finden Sie auf dieser Weise die Ursache des Problems \${normal_color}\${visual_choice}"
	...
	arr["GREEK","wpa3_dragon_drain_attack_7"]="\${pending_of_translation} Το Dragon Drain έχει καταρτιστεί και εγκατασταθεί. Τώρα μπορείτε να συνεχίσετε να ξεκινάτε την επίθεση..."
	...
	arr["GERMAN","wpa3_dragon_drain_attack_7"]="\${pending_of_translation} Dragon Drain wurde zusammengestellt und installiert. Jetzt können Sie den Angriff weiter starten..."
	...
	arr["GREEK","wpa3_dragon_drain_attack_8"]="\${pending_of_translation} Οι απαραίτητες εξαρτήσεις εγκαθίστανται"
	...
	arr["GERMAN","wpa3_dragon_drain_attack_8"]="\${pending_of_translation} Die notwendigen Abhängigkeiten sind installiert"
	...
	arr["GREEK","wpa3_dragon_drain_attack_9"]="\${pending_of_translation} Υπήρξε κάποιο πρόβλημα στη διαδικασία εγκατάστασης και συλλογής. Ελέγξτε τα μηνύματα στην οθόνη και λύστε το πρόβλημα. Η επίθεση δεν μπορεί να ξεκινήσει"
	...
	arr["GREEK","wpa3_dragon_drain_attack_10"]="\${pending_of_translation} Το chipset Atheros ανιχνεύθηκε χωρίς ενότητα \${normal_color}ath_masker\${yellow_color}. Είναι απαραίτητο για τα chipsets του Atheros να κάνουν αυτή την επίθεση να λειτουργήσει σωστά. Θα εγκατασταθεί"
	...
	arr["GERMAN","wpa3_dragon_drain_attack_10"]="\${pending_of_translation} Atheros -Chipsatz ohne \${normal_color}ath_masker\${yellow_color}-Modul. Es ist erforderlich, damit Atheros -Chipsätze diesen Angriff richtig funktionieren. Es wird installiert"
	...
	arr["GREEK","wpa3_dragon_drain_attack_11"]="\${pending_of_translation} Η μονάδα πυρήνα \${normal_color}ath_masker\${blue_color} εγκαταστάθηκε με επιτυχία"
	...
	arr["GERMAN","wpa3_dragon_drain_attack_11"]="\${pending_of_translation} \${normal_color}ath_masker\${blue_color} kernel modul wurde erfolgreich installiert"
	...
	arr["GREEK","wpa3_dragon_drain_attack_12"]="\${pending_of_translation} Υπήρχε πρόβλημα εγκατάστασης της μονάδας πυρήνα \${normal_color}ath_masker\${yellow_color}. Η αξιοπιστία της επίθεσης θα μπορούσε να επηρεαστεί. Φροντίστε να εγκαταστήσετε αυτό το χέρι (\${normal_color}\${ath_masker_repo}\${yellow_color}) όπως είναι απαραίτητο για chipsets Atheros"
	...
	arr["GREEK","wpa3_dragon_drain_attack_13"]="\${pending_of_translation} Το chipset Atheros έχει ανιχνευθεί και η ενότητα του πυρήνα \${normal_color}ath_masker\${blue_color} έχει επίσης εγκατασταθεί"
	...
	arr["GERMAN","wpa3_dragon_drain_attack_13"]="\${pending_of_translation} Der Atheros-Chipsatz wurde erkannt und das Kernel -Modul \${normal_color}ath_masker\${blue_color} ist ebenfalls installiert"
	...
	arr["GREEK","wpa3_dragon_drain_attack_14"]="\${pending_of_translation} Οι απαραίτητες εξαρτήσεις τώρα θα ελεγχθούν"
	...
	arr["GERMAN","wpa3_dragon_drain_attack_14"]="\${pending_of_translation} Die benötigten Abhängigkeiten werden jetzt überprüft"
	...
	arr["GREEK","wpa3_dragon_drain_attack_16"]="\${pending_of_translation} Δεν χρειάζεται να ελέγξετε τις εξαρτήσεις. Ελέγχτηκαν προηγουμένως"
	...
	arr["GERMAN","wpa3_dragon_drain_attack_16"]="\${pending_of_translation} Keine Notwendigkeit, Abhängigkeiten zu überprüfen. Sie wurden zuvor überprüft"
	...
	arr["SPANISH","wpa3_dragon_drain_attack_17"]="Ajuste de bitrate compatible con tu chipset. Ajustaando para mejorar el rendimiento..."
	...
	arr["GREEK","wpa3_dragon_drain_attack_17"]="\${pending_of_translation} Ρύθμιση bitrate που υποστηρίζεται από το chipset σας. Ρυθμίζοντας το για βελτίωση της αξιοπιστίας..."
	...
	arr["GERMAN","wpa3_dragon_drain_attack_17"]="\${pending_of_translation} Die von Ihrem Chipsatz unterstützte bitrate-Einstellung. Anpassen, um die Zuverlässigkeit zu verbessern..."

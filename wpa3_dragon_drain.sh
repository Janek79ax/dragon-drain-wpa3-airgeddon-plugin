...
function wpa3_dragon_drain_prehook_hookable_for_languages() {
	...
	arr["GREEK","wpa3_dragon_drain_attack_16"]="\${pending_of_translation} Το chipset Atheros ανιχνεύθηκε χωρίς το module \${normal_color}ath_masker\${yellow_color}. Είναι απαραίτητο για τα chipsets Atheros ώστε η επίθεση να λειτουργήσει σωστά. θα εγκατασταθεί"

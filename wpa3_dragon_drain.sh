...
function wpa3_dragon_drain_prehook_hookable_for_languages() {
	...
	arr["ITALIAN","wpa3_dragon_drain_attack_18"]="\${pending_of_translation} Sembra che tu non abbia connessione a internet. È necessario poiché i componenti devono essere installati per eseguire l'attacco"

...
plugin_wpa3_menu_option_function="wpa3_dragon_drain_attack_option"
plugin_wpa3_menu_option_language_string="wpa3_dragon_drain_attack_menu_option"
...
function exec_wpa3_dragon_drain_attack() {
	...
	if ! wait_for_process "${python3} ${scriptfolder}${plugins_dir}wpa3_dragon_drain_attack.py ${bssid} ${channel} ${interface} ${dragon_drain_install_path}" "wpa3 dragon drain attack"; then
		return 1
	fi
}
...
function wpa3_dragon_drain_prehook_hookable_for_languages() {
	...
	arr["ENGLISH","wpa3_dragon_drain_attack_menu_option"]="WPA3 Dragon Drain attack"
	arr["SPANISH","wpa3_dragon_drain_attack_menu_option"]="Ataque Dragon Drain WPA3"
	arr["FRENCH","wpa3_dragon_drain_attack_menu_option"]="Attaque de Dragon Drain WPA3"
	arr["CATALAN","wpa3_dragon_drain_attack_menu_option"]="Atac WPA3 Dragon Drain"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_menu_option"]="Ataque Dragon Drain WPA3"
	arr["RUSSIAN","wpa3_dragon_drain_attack_menu_option"]="Атака WPA3 Dragon Drain"
	arr["GREEK","wpa3_dragon_drain_attack_menu_option"]="Επίθεση WPA3 Dragon Drain"
	arr["ITALIAN","wpa3_dragon_drain_attack_menu_option"]="Attacco WPA3 Dragon Drain"
	arr["POLISH","wpa3_dragon_drain_attack_menu_option"]="Atak WPA3 Dragon Drain"
	arr["GERMAN","wpa3_dragon_drain_attack_menu_option"]="WPA3 Dragon Drain Angriff"
	arr["TURKISH","wpa3_dragon_drain_attack_menu_option"]="WPA3 Dragon Drain saldırı"
	arr["ARABIC","wpa3_dragon_drain_attack_menu_option"]="WPA3 Dragon Drain هجوم"
	arr["CHINESE","wpa3_dragon_drain_attack_menu_option"]="WPA3 Dragon Drain 攻击"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_18"]="Il semble que vous ne pouvez pas vous connecter à internet. Il est nécessaire parce que les composants doivent être installés pour effectuer l'attaque"
	arr["CATALAN","wpa3_dragon_drain_attack_18"]="Sembla que no tens connexió a internet. És necessari ja que s’han d’instal·lar components per dur a terme l’atac"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_18"]="Parece que você não tem acesso à internet. A conexão é necessária, pois os componentes precisam ser instalados para executar o ataque"
	arr["RUSSIAN","wpa3_dragon_drain_attack_18"]="Похоже, у вас нет доступа в интернет. Это необходимо, так как для выполнения атаки нужно установить дополнительные компоненты"
	arr["GREEK","wpa3_dragon_drain_attack_18"]="Φαίνεται ότι δεν έχετε πρόσβαση στο διαδίκτυο. Αυτό είναι απαραίτητο, καθώς πρέπει να εγκατασταθούν τα στοιχεία για να πραγματοποιηθεί η επίθεση"
	...
	arr["GERMAN","wpa3_dragon_drain_attack_18"]="Es scheint, dass Sie keine Internetverbindung haben. Eine Verbindung ist notwendig, da Komponenten installiert werden müssen, um den Angriff auszuführen"
	...
	arr["ARABIC","wpa3_dragon_drain_attack_18"]="يبدو أنه ليس لديك اتصال بالإنترنت. يعد الاتصال ضروريًا لأن المكوّنات يجب أن تُثبَّت لتنفيذ الهجوم"
	arr["CHINESE","wpa3_dragon_drain_attack_18"]="您似乎无法访问互联网。但必须安装必要组件才能进行下一步攻击"
}

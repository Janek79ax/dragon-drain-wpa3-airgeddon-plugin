...
function wpa3_dragon_drain_prehook_hookable_for_languages() {
	...
	arr["FRENCH","wpa3_dragon_drain_attack_3"]="5.  Attaque de Dragon Drain WPA3"
	arr["CATALAN","wpa3_dragon_drain_attack_3"]="5.  Atac WPA3 Dragon Drain"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_3"]="5.  Ataque Dragon Drain WPA3"
	arr["RUSSIAN","wpa3_dragon_drain_attack_3"]="5.  Атака WPA3 Dragon Drain"
	arr["GREEK","wpa3_dragon_drain_attack_3"]="5.  Επίθεση WPA3 Dragon Drain"
	arr["ITALIAN","wpa3_dragon_drain_attack_3"]="5.  Attacco WPA3 Dragon Drain"
	arr["POLISH","wpa3_dragon_drain_attack_3"]="5.  Atak WPA3 Dragon Drain"
	arr["GERMAN","wpa3_dragon_drain_attack_3"]="5.  WPA3 Dragon Drain Angriff"
	arr["TURKISH","wpa3_dragon_drain_attack_3"]="5.  WPA3 Dragon Drain saldırı"
	arr["ARABIC","wpa3_dragon_drain_attack_3"]="5.  WPA3 Dragon Drain هجوم"
	arr["CHINESE","wpa3_dragon_drain_attack_3"]="5.  WPA3 Dragon Drain 攻击"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_5"]="L'attaque Dragon Drain de WPA3 s'exécute indéfiniment pour surcharger le routeur (DoS)"
	arr["CATALAN","wpa3_dragon_drain_attack_5"]="L'atac Dragon Drain de WPA3 s'executa indefinidament amb l'objectiu de sobrecarregar el router (DoS)"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_5"]="O ataque Dragon Drain do WPA3 executa indefinidamente com o objetivo de sobrecarregar o roteador (DoS)"
	arr["RUSSIAN","wpa3_dragon_drain_attack_5"]="Атака Dragon Drain WPA3 длится бесконечно и направлена на перегрузку маршрутизатора (DoS)"
	arr["GREEK","wpa3_dragon_drain_attack_5"]="Η επίθεση WPA3 Dragon Drain εκτελείται συνεχώς με σκοπό να υπερφορτώσει τον δρομολογητή (DoS)"
	arr["ITALIAN","wpa3_dragon_drain_attack_5"]="L'attacco Dragon Drain di WPA3 viene eseguito all'infinito per sovraccaricare il router (DoS)"
	arr["POLISH","wpa3_dragon_drain_attack_5"]="Atak WPA3 Dragon Drain działa nieustannie, próbując przeciążyć router poprzez wyczerpanie jego zasobów (DoS)"
	arr["GERMAN","wpa3_dragon_drain_attack_5"]="Der WPA3-Dragon-Drain-Angriff läuft ununterbrochen, um den Router zu überlasten (DoS)"
	arr["TURKISH","wpa3_dragon_drain_attack_5"]="WPA3 Dragon Drain saldırısı, yönlendiriciyi aşırı yüklemek amacıyla kesintisiz olarak devam eder (DoS)"
	arr["ARABIC","wpa3_dragon_drain_attack_5"]="(DoS) يستمر بلا توقف بهدف إغراق جهاز التوجيه وإحداث هجوم حجب الخدمة WPA3 Dragon Drain هجوم"
	arr["CHINESE","wpa3_dragon_drain_attack_5"]="针对 WPA3 的资源耗尽攻击将持续运行，旨在使路由器过载。 (即DoS)"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_11"]="Une erreur s'est produite en installant les dependencies. Vérifiez votre connexion d'Internet ou s'il y a un problème dans votre système"
	arr["CATALAN","wpa3_dragon_drain_attack_11"]="S'ha produït un error instal·lant les dependencies. Comproveu la vostra connexió a Internet o si hi ha algun problema al vostre sistema"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_11"]="Ocorreu um erro ao instalar as dependências. Verifique sua conexão com a Internet ou se há algum problema em seu sistema"
	arr["RUSSIAN","wpa3_dragon_drain_attack_11"]="Ошибка произошла при установке зависимостей. Убедитесь, что ваше интернет-соединение работает и проверьте нет ли проблем в системе"
	arr["GREEK","wpa3_dragon_drain_attack_11"]="Παρουσιάστηκε σφάλμα κατά την εγκατάσταση των dependencies. Ελέγξτε τη σύνδεσή σας στο διαδίκτυο ή εάν υπάρχει κάποιο πρόβλημα στο σύστημά σας"
	arr["ITALIAN","wpa3_dragon_drain_attack_11"]="Si è verificato un errore durante l'installazione delle dipendenze. Controlla la tua connessione a Internet o se c'è qualche problema nel sistema"
	arr["POLISH","wpa3_dragon_drain_attack_11"]="Instalacja zależności nie powiodła się. Sprawdź, czy masz połączenie internetowe i czy system działa poprawnie"
	arr["GERMAN","wpa3_dragon_drain_attack_11"]="Beim Installieren der Abhängigkeiten ist ein Fehler aufgetreten. Überprüfen Sie Ihre Internetverbindung oder ob ein Problem mit Ihrem System vorliegt"
	arr["TURKISH","wpa3_dragon_drain_attack_11"]="Bağımlılıkların kurulması sırasında bir hata oluştu. İnternet bağlantınızı kontrol edin veya sisteminizde bir sorun olup olmadığını denetleyin"
	arr["ARABIC","wpa3_dragon_drain_attack_11"]="حدث خطأ أثناء تثبيت التبعيات. تحقق من اتصالك بالإنترنت أو من وجود أي مشاكل في نظامك"
	arr["CHINESE","wpa3_dragon_drain_attack_11"]="安装依赖时发生了一个错误。检查您的网络连接或系统是否有其他问题"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_12"]="Voulez-vous voir le résultat de l'erreur survenue lors de l'actualisation/installation? \${blue_color}Peut-être de cette façon vous pourriez trouver la cause principale du problème \${normal_color}\${visual_choice}"
	arr["CATALAN","wpa3_dragon_drain_attack_12"]="Voleu veure la sortida de l'error que heu donat en actualitzar/instal·lar? \${blue_color}Potser així trobareu la causa principal del problema \${normal_color}\${visual_choice}"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_12"]="Deseja ver o erro ocorrido durante a atualização/instalação? \${blue_color}Talvez assim você possa encontrar a causa raiz do problema \${normal_color}\${visual_choice}"
	arr["RUSSIAN","wpa3_dragon_drain_attack_12"]="Хотите увидеть вывод ошибки, возникшей во время обновления/установки? \${blue_color}Возможно, таким образом Вам удастся установить причину проблемы \${normal_color}\${visual_choice}"
	arr["GREEK","wpa3_dragon_drain_attack_12"]="Θέλετε να δείτε το output του σφάλματος που προέκυψε κατά την ενημέρωση/εγκατάσταση; \${blue_color}Ίσως με αυτόν τον τρόπο να βρείτε τη βασική αιτία του προβλήματος \${normal_color}\${visual_choice}"
	arr["ITALIAN","wpa3_dragon_drain_attack_12"]="Vuoi vedere l'output dell'errore che si è verificato durante l'aggiornamento/installazione? \${blue_color}Forse in questo modo potresti scoprire la causa del problema \${normal_color}\${visual_choice}"
	...
	arr["ARABIC","wpa3_dragon_drain_attack_12"]="\${normal_color}\${visual_choice} \${blue_color}قد يساعدك ذلك في تحديد السبب الجذري للمشكلة \${green_color}هل تريد عرض مخرجات الخطأ الذي حدث أثناء التحديث/التثبيت؟"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_13"]="Dragon Drain a été compilé et installé. Vous pouvez maintenant continuer à lancer l'attaque..."
	arr["CATALAN","wpa3_dragon_drain_attack_13"]="Dragon Drain s’ha compilat i instal·lat. Ara podeu continuar llançant l'atac..."
	arr["PORTUGUESE","wpa3_dragon_drain_attack_13"]="O Dragon Drain foi compilado e instalado. Agora você pode continuar com o ataque..."
	arr["RUSSIAN","wpa3_dragon_drain_attack_13"]="Dragon Drain был успешно скомпилирован и установлен. Теперь вы можете перейти к запуску атаки..."
	arr["GREEK","wpa3_dragon_drain_attack_13"]="Το Dragon Drain έγινε compile και εγκαταστάθηκε με επιτυχία. Είναι πλέον δυνατό να συνεχίσετε με την εκτέλεση της επίθεσης..."
	arr["ITALIAN","wpa3_dragon_drain_attack_13"]="Dragon Drain è stato compilato e installato con successo. Ora puoi continuare per lanciare l'attacco..."
	arr["POLISH","wpa3_dragon_drain_attack_13"]="Dragon Drain został skompilowany i zainstalowany. Możesz teraz kontynuować atak..."
	arr["GERMAN","wpa3_dragon_drain_attack_13"]="Dragon Drain wurde kompiliert und installiert. Jetzt können Sie den Angriff weiter starten..."
	arr["TURKISH","wpa3_dragon_drain_attack_13"]="Dragon Drain başarıyla derlendi ve kuruldu. Şimdi saldırıyı başlatmaya devam edebilirsiniz..."
	arr["ARABIC","wpa3_dragon_drain_attack_13"]="...بنجاح يمكنك الآن المتابعة لتنفيذ الهجوم Dragon Drain تم تجميع وتثبيت"
	arr["CHINESE","wpa3_dragon_drain_attack_13"]="Dragon Drain 二进制文件已编译且安装完成。现在您可以继续发动攻击..."
	...
	arr["FRENCH","wpa3_dragon_drain_attack_14"]="Les dépendances nécessaires sont installées"
	arr["CATALAN","wpa3_dragon_drain_attack_14"]="Les dependències necessàries estan instal·lades"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_14"]="As dependências necessárias estão instaladas"
	arr["RUSSIAN","wpa3_dragon_drain_attack_14"]="Необходимые зависимости установлены"
	arr["GREEK","wpa3_dragon_drain_attack_14"]="Τα απαραίτητα dependencies έχουν εγκατασταθεί"
	arr["ITALIAN","wpa3_dragon_drain_attack_14"]="Le dipendenze necessarie sono installate"
	arr["POLISH","wpa3_dragon_drain_attack_14"]="Niezbędne zależności są instalowane"
	arr["GERMAN","wpa3_dragon_drain_attack_14"]="Die notwendigen Abhängigkeiten sind installiert"
	arr["TURKISH","wpa3_dragon_drain_attack_14"]="Gerekli bağımlılıklar başarıyla kuruldu"
	arr["ARABIC","wpa3_dragon_drain_attack_14"]="تم تثبيت التبعيات اللازمة"
	arr["CHINESE","wpa3_dragon_drain_attack_14"]="必要的依赖已安装完成"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_15"]="Il y a eu un problème dans le processus d'installation et de compilation. Veuillez vérifier les messages à l'écran et résoudre le problème. L'attaque ne peut pas être lancée"
	arr["CATALAN","wpa3_dragon_drain_attack_15"]="Hi ha hagut algun problema en el procés d’instal·lació i recopilació. Comproveu els missatges de la pantalla i solucioneu el problema. L’atac no es pot llançar"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_15"]="Houve um problema no processo de instalação e compilação. Por favor, verifique as mensagens na tela e resolva o problema. O ataque não pode ser iniciado"
	arr["RUSSIAN","wpa3_dragon_drain_attack_15"]="В процессе установки и компиляции возникла проблема. Пожалуйста, проверьте сообщения на экране и устраните проблему. Невозможно запустить атаку"
	arr["GREEK","wpa3_dragon_drain_attack_15"]="Παρουσιάστηκε πρόβλημα κατά τη διαδικασία εγκατάστασης και compile. Παρακαλώ ελέγξτε τα μηνύματα στην οθόνη και διορθώστε το πρόβλημα. Η επίθεση δεν μπορεί να ξεκινήσει"
	arr["ITALIAN","wpa3_dragon_drain_attack_15"]="C'è stato qualche problema nel processo di installazione e compilazione. Si prega di controllare i messaggi sullo schermo e risolvere il problema. L'attacco non può essere lanciato"
	arr["POLISH","wpa3_dragon_drain_attack_15"]="Proces instalacji i kompilacji napotkał trudności. Przeanalizuj wyświetlane komunikaty i usuń problem, aby umożliwić przeprowadzenie ataku"
	arr["GERMAN","wpa3_dragon_drain_attack_15"]="Es gab ein Problem während den Installations-und Kompilierungsprozess. Bitte überprüfen Sie die Nachrichten auf dem Bildschirm und lösen Sie das Problem. Der Angriff kann nicht gestartet werden"
	arr["TURKISH","wpa3_dragon_drain_attack_15"]="Kurulum ve derleme sürecinde bir sorun oluştu. Lütfen ekrandaki mesajları kontrol edin ve sorunu giderin. Saldırı başlatılamaz"
	arr["ARABIC","wpa3_dragon_drain_attack_15"]="حدثت مشكلة أثناء عملية التثبيت أو التجميع. يرجى مراجعة الرسائل المعروضة على الشاشة وحل المشكلة، حيث لا يمكن تنفيذ الهجوم قبل ذلك"
	arr["CHINESE","wpa3_dragon_drain_attack_15"]="安装和编译过程中出现了问题。请检查屏幕上的错误信息并尝试解决。目前无法启动攻击"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_16"]="Chipset Atheros détecté sans module \${normal_color}ath_masker\${yellow_color}. Il est nécessaire que les chipsets d'Atheros fassent correctement fonctionner cette attaque. Il sera installé"
	arr["CATALAN","wpa3_dragon_drain_attack_16"]="Chipset Atheros detectat sense \${normal_color}ath_masker\${yellow_color} Mòdul. Cal que els chipsets Atheros facin que aquest atac funcioni correctament. S’instal·larà"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_16"]="Chipset Atheros detectado sem o módulo \${normal_color}ath_masker\${yellow_color}. Esse módulo é necessário para que chipsets Atheros executem este ataque corretamente. A instalação será realizada"
	arr["RUSSIAN","wpa3_dragon_drain_attack_16"]="Обнаружен чипсет Atheros без модуля \${normal_color}ath_masker\${yellow_color}. Он необходим для корректной работы этой атаки на чипсетах Atheros. Модуль будет установлен"
	arr["GREEK","wpa3_dragon_drain_attack_16"]="Το chipset Atheros ανιχνεύθηκε χωρίς το module \${normal_color}ath_masker\${yellow_color}. Είναι απαραίτητο για τα chipsets Atheros ώστε η επίθεση να λειτουργήσει σωστά. θα εγκατασταθεί"
	arr["ITALIAN","wpa3_dragon_drain_attack_16"]="Chipset Atheros rilevato senza il modulo \${normal_color}ath_masker\${yellow_color}. È necessario averlo affinché i chipset Atheros facciano funzionare questo attacco correttamente. Sarà installato"
	arr["POLISH","wpa3_dragon_drain_attack_16"]="Wykryto chipset Atheros bez modułu \${normal_color}ath_masker\${yellow_color}. Jest on wymagany do prawidłowego działania ataku na chipsetach Atheros. Zostanie teraz zainstalowany"
	arr["GERMAN","wpa3_dragon_drain_attack_16"]="Atheros-Chipset ohne \${normal_color}ath_masker\${yellow_color}-Modul. Es ist erforderlich, damit Atheros-Chipsets diesen Angriff richtig funktionieren. Es wird installiert"
	arr["TURKISH","wpa3_dragon_drain_attack_16"]="Atheros yonga seti \${normal_color}ath_masker\${yellow_color} modülü olmadan tespit edildi. Bu saldırının düzgün çalışabilmesi için Atheros yonga setlerine ihtiyaç vardır. Modül kurulacak"
	arr["ARABIC","wpa3_dragon_drain_attack_16"]="وهو ضروري لعمل الهجوم بشكل صحيح على هذه الشرائح. سيتم تثبيته الآن ,kernel module \${normal_color}ath_masker\${yellow_color} بدون Atheros تم اكتشاف"
	arr["CHINESE","wpa3_dragon_drain_attack_16"]="Atheros芯片组检测到缺少\${normal_color}ath_masker\${yellow_color}内核模块。模块即将安装"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_17"]="Le module du kernel \${normal_color}ath_masker\${blue_color} a été installé avec succès"
	arr["CATALAN","wpa3_dragon_drain_attack_17"]="El mòdul del kernel \${normal_color}ath_masker\${blue_color} es va instal·lar amb èxit"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_17"]="O módulo \${normal_color}ath_masker\${blue_color} kernel foi instalado com sucesso"
	arr["RUSSIAN","wpa3_dragon_drain_attack_17"]="Модуль ядра \${normal_color}ath_masker\${blue_color} был успешно установлен"
	arr["GREEK","wpa3_dragon_drain_attack_17"]="Το kernel module \${normal_color}ath_masker\${blue_color} εγκαταστάθηκε με επιτυχία"
	arr["ITALIAN","wpa3_dragon_drain_attack_17"]="Il modulo kernel \${normal_color}ath_masker\${blue_color} è stato installato correttamente"
	arr["POLISH","wpa3_dragon_drain_attack_17"]="Moduł jądra \${normal_color}ath_masker\${blue_color} został pomyślnie zainstalowany"
	arr["GERMAN","wpa3_dragon_drain_attack_17"]="\${normal_color}ath_masker\${blue_color} Kernel-Modul wurde erfolgreich installiert"
	arr["TURKISH","wpa3_dragon_drain_attack_17"]="\${normal_color}ath_masker\${blue_color} çekirdek modülü başarıyla yüklendi"
	arr["ARABIC","wpa3_dragon_drain_attack_17"]="بنجاح kernel module \${normal_color}ath_masker\${blue_color} تم تثبيت"
	arr["CHINESE","wpa3_dragon_drain_attack_17"]="\${normal_color}ath_masker\${blue_color}内核模块已成功安装"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_18"]="Un problème est survenu lors de l'installation du module noyau \${normal_color}ath_masker\${yellow_color}. La fiabilité de l'attaque pourrait être affectée. Veuillez l’installer manuellement (\${normal_color}\${ath_masker_repo}\${yellow_color}), car il est nécessaire pour les chipsets Atheros"
	arr["CATALAN","wpa3_dragon_drain_attack_18"]="Hi va haver un problema per instal·lar el mòdul del kernel \${normal_color}ath_masker\${yellow_color}. La fiabilitat de l’atac es podria veure afectada. Assegureu-vos d’instal·lar-ho manualment (\${normal_color}\${ath_masker_repo}\${yellow_color}), ja que es necessita per a chipsets d’Atheros"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_18"]="Houve um problema ao instalar o módulo de kernel \${normal_color}ath_masker\${yellow_color}. A confiabilidade do ataque pode ser afetada. Certifique-se de instalá-lo manualmente (\${normal_color}\${ath_masker_repo}\${yellow_color}), pois ele é necessário para chipsets Atheros"
	arr["RUSSIAN","wpa3_dragon_drain_attack_18"]="Возникла проблема с установкой модуля ядра \${normal_color}ath_masker\${yellow_color}. Это может повлиять на надежность атаки. Обязательно установите его вручную (\${normal_color}\${ath_masker_repo}\${yellow_color}), так как он необходим для чипсетов Atheros"
	arr["GREEK","wpa3_dragon_drain_attack_18"]="Παρουσιάστηκε πρόβλημα κατά την εγκατάσταση του kernel module \${normal_color}ath_masker\${yellow_color}. Η αξιοπιστία της επίθεσης μπορεί να επηρεαστεί. Βεβαιωθείτε ότι το εγκαθιστάτε χειροκίνητα (\${normal_color}\${ath_masker_repo}\${yellow_color}) καθώς είναι απαραίτητο για τα chipsets Atheros"
	arr["ITALIAN","wpa3_dragon_drain_attack_18"]="C'è stato un problema installando il modulo kernel \${normal_color}ath_masker\${yellow_color}. L'affidabilità dell'attacco potrebbe essere influenzata. Assicurati di installarlo manualmente (\${normal_color}\${ath_masker_repo}\${yellow_color}) in quanto è necessario per i chipset Atheros"
	arr["POLISH","wpa3_dragon_drain_attack_18"]="Wystąpił problem z instalacją modułu \${normal_color}ath_masker\${yellow_color}. Może to wpłynąć na skuteczność ataku. Pamiętaj, aby zainstalować ręcznie (\${normal_color}\${ath_masker_repo}\${yellow_color}), potrzebny do chipsetów Atheros"
	arr["GERMAN","wpa3_dragon_drain_attack_18"]="Bei der Installation des Kernelmoduls \${normal_color}ath_masker\${yellow_color} ist ein Problem aufgetreten. Die Effektivität des Angriffs kann dadurch beeinträchtigt werden. Installieren Sie es unbedingt manuell (\${normal_color}\${ath_masker_repo}\${yellow_color}), da es für Atheros-Chips erforderlich ist"
	arr["TURKISH","wpa3_dragon_drain_attack_18"]="\${normal_color}ath_masker\${yellow_color} çekirdek modülü kurulurken bir sorun oluştu. Saldırının güvenilirliği etkilenebilir. Atheros yonga setleri için gerekli olduğundan (\${normal_color}\${ath_masker_repo}\${yellow_color}) adresinden manuel olarak yüklediğinizden emin olun"
	arr["ARABIC","wpa3_dragon_drain_attack_18"]="Atheros لأنه ضروري لـ (\${normal_color}\${ath_masker_repo}\${yellow_color}) قد تتأثر موثوقية الهجوم. تأكد من تثبيته يدويًا من kernel module \${normal_color}ath_masker\${yellow_color} حدثت مشكلة أثناء تثبيت"
	arr["CHINESE","wpa3_dragon_drain_attack_18"]="安装 \${normal_color}ath_masker\${yellow_color} 内核模块存在问题。攻击的可靠性可能会受到影响。请务必手动安装（\${normal_color}\${ath_masker_repo}\${yellow_color}）它Atheros芯片组所必须的"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_19"]="Le chipset Atheros a été détecté et le module du kernel \${normal_color}ath_masker\${blue_color} est également installé"
	arr["CATALAN","wpa3_dragon_drain_attack_19"]="S'ha detectat chipset Atheros i a més el mòdul del kernel \${normal_color}ath_masker\${blue_color} també està instal·lat"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_19"]="O chipset Atheros foi detectado e o módulo do kernel \${normal_color}ath_masker\${blue_color} também está instalado"
	arr["RUSSIAN","wpa3_dragon_drain_attack_19"]="Обнаружен чипсет Atheros, модуль ядра \${normal_color}ath_masker\${blue_color} установлен"
	arr["GREEK","wpa3_dragon_drain_attack_19"]="Ανιχνεύθηκε chipset Atheros και το kernel module \${normal_color}ath_masker\${blue_color} είναι επίσης εγκατεστημένο"
	arr["ITALIAN","wpa3_dragon_drain_attack_19"]="È stato rilevato il chipset Atheros e anche il modulo kernel \${normal_color}ath_masker\${blue_color} è installato"
	arr["POLISH","wpa3_dragon_drain_attack_19"]="Chipset Atheros i zainstalowany moduł jądra \${normal_color}ath_masker\${blue_color} zostały wykryte"
	arr["GERMAN","wpa3_dragon_drain_attack_19"]="Der Atheros-Chipsatz wurde erkannt und das Kernel-Modul \${normal_color}ath_masker\${blue_color} ist ebenfalls installiert"
	arr["TURKISH","wpa3_dragon_drain_attack_19"]="Atheros yonga seti tespit edildi ve \${normal_color}ath_masker\${blue_color} çekirdek modülü de yüklendi"
	arr["ARABIC","wpa3_dragon_drain_attack_19"]=" مثبت بالفعل kernel module \${normal_color}ath_masker\${blue_color} و Atheros تم اكتشاف"
	arr["CHINESE","wpa3_dragon_drain_attack_19"]="已经检测到Atheros芯片组，已经检测到 \${normal_color}ath_masker\${blue_color} 内核模块"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_20"]="Les dépendances nécessaires seront vérifiées maintenant"
	arr["CATALAN","wpa3_dragon_drain_attack_20"]="Ara es comprovaran les dependències necessàries"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_20"]="As dependências necessárias serão verificadas"
	arr["RUSSIAN","wpa3_dragon_drain_attack_20"]="Теперь будет проведена проверка необходимых зависимостей"
	arr["GREEK","wpa3_dragon_drain_attack_20"]="Θα γίνει τώρα έλεγχος των απαραίτητων dependencies"
	arr["ITALIAN","wpa3_dragon_drain_attack_20"]="Le dipendenze necessarie verranno controllate adesso"
	arr["POLISH","wpa3_dragon_drain_attack_20"]="Wymagane zależności zostaną teraz sprawdzone"
	arr["GERMAN","wpa3_dragon_drain_attack_20"]="Die benötigten Abhängigkeiten werden jetzt überprüft"
	arr["TURKISH","wpa3_dragon_drain_attack_20"]="Gerekli bağımlılıklar şimdi kontrol ediliyor"
	arr["ARABIC","wpa3_dragon_drain_attack_20"]="سيتم الآن التحقق من التبعيات المطلوبة"
	arr["CHINESE","wpa3_dragon_drain_attack_20"]="现在将检查所需的依赖项"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_22"]="Pas besoin de vérifier les dépendances. Ils ont été deja vérifiés"
	arr["CATALAN","wpa3_dragon_drain_attack_22"]="No cal comprovar les dependències. Es van comprovar anteriorment"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_22"]="Não é necessário verificar as dependências. Elas já foram verificadas anteriormente"
	arr["RUSSIAN","wpa3_dragon_drain_attack_22"]="Нет необходимости проверять зависимости. Они были проверены ранее"
	arr["GREEK","wpa3_dragon_drain_attack_22"]="Δεν χρειάζεται έλεγχος των dependencies. Ελέγχτηκαν προηγουμένως"
	arr["ITALIAN","wpa3_dragon_drain_attack_22"]="Non c'è bisogno di controllare le dipendenze. Sono state controllate in precedenza"
	arr["POLISH","wpa3_dragon_drain_attack_22"]="Nie trzeba sprawdzać zależności. Były wcześniej sprawdzone"
	arr["GERMAN","wpa3_dragon_drain_attack_22"]="Keine Notwendigkeit, Abhängigkeiten zu überprüfen. Sie wurden zuvor überprüft"
	arr["TURKISH","wpa3_dragon_drain_attack_22"]="Bağımlılıkları tekrar kontrol etmeye gerek yok. Daha önce kontrol edildi"
	arr["ARABIC","wpa3_dragon_drain_attack_22"]="لا حاجة للتحقق من التبعيات، حيث تم التحقق منها مسبقًا"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_23"]="Réglage du bitrate pris en charge par votre chipset. L'ajuster pour améliorer la fiabilité..."
	...
	arr["RUSSIAN","wpa3_dragon_drain_attack_23"]="Ваш чипсет поддерживает регулировку битрейта. Регулируем его для повышения надежности..."
	arr["GREEK","wpa3_dragon_drain_attack_23"]="Υποστηρίζεται προσαρμογή bitrate από το chipset σας. Γίνεται προσαρμογή για βελτίωση της αξιοπιστίας..."
	arr["ITALIAN","wpa3_dragon_drain_attack_23"]="Regolazione del bitrate supportata dal tuo chipset. Regolandolo per migliorare l'affidabilità..."
	arr["POLISH","wpa3_dragon_drain_attack_23"]="Wykryto obsługę zmiany bitrate przez chipset. Automatyczna korekta w celu poprawy stabilności..."
	arr["GERMAN","wpa3_dragon_drain_attack_23"]="Die von Ihrem Chipsatz unterstützte bitrate-Einstellung. Anpassen, um die Zuverlässigkeit zu verbessern..."
	arr["TURKISH","wpa3_dragon_drain_attack_23"]="Yonga setiniz tarafından desteklenen bitrate ayarı bulundu. Güvenilirliği artırmak için bunu ayarlayın..."
	arr["ARABIC","wpa3_dragon_drain_attack_23"]="...الخاصة بك. يتم الآن ضبطه لتحسين الموثوقية chipset متاح في bitrate دعم ضبط"
	...
	arr["FRENCH","wpa3_dragon_drain_attack_24"]="Il semble que vous ne pouvez pas vous connecter à internet. Il est nécessaire parce que les composants doivent être installés pour effectuer l'attaque"
	arr["CATALAN","wpa3_dragon_drain_attack_24"]="Sembla que no tens connexió a internet. És necessari ja que s’han d’instal·lar components per dur a terme l’atac"
	arr["PORTUGUESE","wpa3_dragon_drain_attack_24"]="Parece que você não tem acesso à internet. A conexão é necessária, pois os componentes precisam ser instalados para executar o ataque"
	arr["RUSSIAN","wpa3_dragon_drain_attack_24"]="Похоже, у вас нет доступа в интернет. Это необходимо, так как для выполнения атаки нужно установить дополнительные компоненты"
	arr["GREEK","wpa3_dragon_drain_attack_24"]="Φαίνεται ότι δεν έχετε πρόσβαση στο διαδίκτυο. Αυτό είναι απαραίτητο, καθώς πρέπει να εγκατασταθούν τα στοιχεία για να πραγματοποιηθεί η επίθεση"
	arr["ITALIAN","wpa3_dragon_drain_attack_24"]="Sembra che non sei connesso a internet. È necessario perché i componenti devono essere installati per eseguire l'attacco"
	arr["POLISH","wpa3_dragon_drain_attack_24"]="Nie wykryto połączenia internetowego. Jest ono potrzebne do zainstalowania wymaganych komponentów do przeprowadzenia ataku"
	arr["GERMAN","wpa3_dragon_drain_attack_24"]="Es scheint, dass Sie keine Internetverbindung haben. Eine Verbindung ist notwendig, da Komponenten installiert werden müssen, um den Angriff auszuführen"
	arr["TURKISH","wpa3_dragon_drain_attack_24"]="İnternet erişiminiz yok gibi görünüyor. Saldırının gerçekleştirilebilmesi için bileşenlerin kurulması gerektiğinden internet erişimi gereklidir"
	arr["ARABIC","wpa3_dragon_drain_attack_24"]="يبدو أنه ليس لديك اتصال بالإنترنت. يعد الاتصال ضروريًا لأن المكوّنات يجب أن تُثبَّت لتنفيذ الهجوم"
	arr["CHINESE","wpa3_dragon_drain_attack_24"]="您似乎无法访问互联网。但必须安装必要组件才能进行下一步攻击"
}
